...
const PageIntro = ({ eyebrow, title, children, centered = false }) => {
 ...
 <Container className={clsx("mt-24 sm:mt-32 lg:mt-40", centered && "text-center")}>
    ...
    <h1>
        ...
        <span className={clsx("mt-6 block max-w-5xl font-display font-medium tracking-tight text-neutral-950 [text-wrap:balance] sm:text-6xl", centered && "mx-auto" )}>{title}</span>
    </h1>
