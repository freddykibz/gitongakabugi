  ...
  return (
    <Container>
       <div className='flex items-center justify-between'>
         ...
         <Logo invert ={invert}>Gitonga Kabugi</Logo>
         </Link>
...
const NavigationItem=({ href, children })=>{
  return (
    <Link href={href} className="group relative isolate -mx-6 bg-neutral-950 px-6 py-10 
    even:mt-px sm:mx-0 sm:py-16 sm:odd:pr-16 sm:even:mt-0 sm:even:border-1 sm:even:border-neutral-800 sm:even:pl-16">
    {children}
...
const Navigation = () => {
  ...
  <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
    ...
    <NavigationRow>
       <NavigationItem href={"/blog"}>Blog & Press</NavigationItem>
    ...
    <div className="relative bg-neutral-950 before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-neutral-800">
      <Container>
         <div className='grid grid-cols-1 gap-y-10 pb-16 pt-10 sm:grid-cols-2 sm:pt-16'>
          <div>
            <h2 className='font-display text-base font-semibold text-white'>My Offices</h2>
          ...
          <div className="sm:border-1 sm:border-transparent sm:pl-16">
            <h2 className='font-dispaly text-base font-semibold text-white'>
              Follow Me
            </h2>
